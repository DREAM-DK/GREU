...
**Documentation state (2026-08-19):** all documents are synchronized —
...
start the next session on item 19 (financial-accounts module hardening)
or gap-3, or on any item from the open-decisions list.**
