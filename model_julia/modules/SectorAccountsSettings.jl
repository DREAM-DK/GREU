...
# ---------------------------------------------------------------------------
const fin_transactions_equity_income_items = ["D42", "D43", "D44", "D45"]                       # Distributed income of corporations (ESA D.42); mapped to F51 (equity)
const fin_transactions_debt_income_items   = ["D41"]  # Interest, reinvested earnings, investment fund income, rent; mapped to debt instruments
