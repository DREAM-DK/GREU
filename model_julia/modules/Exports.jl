...
function define_equations()
  return @block model begin
    ...
    qPurchaserUse_p_u_o[p,u,o,t] * pPurchaserUse_p_u_o[p,u,o,t]^eX_p[p] ==
      qXMarket_p[p,t] * pXForeign_p[p,t]^eX_p[p]

    # Imports for re-export do not respond to relative prices.
    rOriginShare[p=reexport_product, u=:X, o=import_origin, t=t1:T],
    qPurchaserUse_p_u_o[p,u,o,t] == qXReexport_p[p,t]

    qXReexport_p[p=reexport_product, t=t1:T],
    qXReexport_p[p,t] == uXReexport_p[p,t] * qXMarket_p[p,t]
    ...
    qCTourist[t=t1:T],
    qCTourist[t] *
      pPurchaserUse_p_u_o[tourist_price_product,:C,domestic,t]^eCTourist ==
    ...
    qX_p[p=domestic_only_export_product, t=t1:T],
    qX_p[p,t] == qPurchaserUse_p_u_o[p,:X,domestic,t]
  end
end
