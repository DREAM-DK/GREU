...
dt.gamY.run("base_model_energy_technology.gms", s="saved/base_model_energy_technology", test_CGE="0", test_abatement="1")
...
dt.gamY.run("shock_CO2_tax.gms", r="saved/base_model_energy_technology", include_abatement="1")

## Run a CO2 tax shock with steps
dt.gamY.run("shock_CO2_tax_steps.gms", r="saved/base_model", include_abatement="0")
dt.gamY.run("shock_CO2_tax_steps.gms", r="saved/base_model_energy_technology", include_abatement="1")
