...
pTPotential.l['t_Electricity_calib',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 1.3 * d1Expensive_tech[es,d,t];
pTPotential.l['t_Electricity_calib_2',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 1.4 * d1Expensive_tech[es,d,t];
