...
pTPotential.l[l,es,d,t]$(sTPotential.l[l,es,d,t]) = sum(e$(uTE.l[l,es,e,d,t]), uTE.l[l,es,e,d,t]*pT_e.l[es,e,d,t])
...
pTPotential.l['t_Electricity_calib',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 1.15 * d1Expensive_tech[es,d,t];
pTPotential.l['t_Electricity_calib_2',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 1.3 * d1Expensive_tech[es,d,t];
...
$IF %stress_decrease_price_backstop_tech% = 1:
  pTPotential.l['t_Electricity_calib',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 1.05 * d1Expensive_tech[es,d,t];
  pTPotential.l['t_Electricity_calib_2',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 1.1 * d1Expensive_tech[es,d,t];
$ENDIF
...
$IF %stress_increase_price_backstop_tech% = 1:
  pTPotential.l['t_Electricity_calib',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 8 * d1Expensive_tech[es,d,t];
  pTPotential.l['t_Electricity_calib_2',es,d,t]$(sum(l, sTPotential.l[l,es,d,t])) = 8.1 * d1Expensive_tech[es,d,t];
$ENDIF
...
uTK.l['t_Electricity_calib',es,d,t]$(t.val=2019 and sum(l, sTPotential.l[l,es,d,t])) 
  = (pTPotential.l['t_Electricity_calib',es,d,t] - sum(e, uTE.l['t_Electricity_calib',es,e,d,t]*pT_e.l[es,e,d,t]))
    / pT_k.l[d,t];
uTK.l['t_Electricity_calib_2',es,d,t]$(t.val=2019 and sum(l, sTPotential.l[l,es,d,t])) 
  = (pTPotential.l['t_Electricity_calib_2',es,d,t] - sum(e, uTE.l['t_Electricity_calib_2',es,e,d,t]*pT_e.l[es,e,d,t]))
    / pT_k.l[d,t];
