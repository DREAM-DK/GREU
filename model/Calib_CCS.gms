...
sqTPotential.l[CCS_techs,'process_special','23001',t]$(t.val > 2025) 
  = sqTPotential.l['t7','process_special','23001',t];

# Investment costs
vTI.l[CCS_techs,'process_special','23001',t]$(t.val > 2025) 
  = vTI.l['t7','process_special','23001',t] + 0.1;

# Operating costs
vTC.l[CCS_techs,'process_special','23001',t]$(t.val > 2025) 
  = vTI.l[CCS_techs,'process_special','23001',t]/10;

# Energy input
uTE.l[CCS_techs,'process_special',e,'23001',t]$(t.val > 2025) 
  = uTE.l['t7','process_special',e,'23001',t];
...
uTE.l[CCS_techs,'process_special','Captured CO2','23001',t]$(t.val > 2025)
  = -sum((em,ee)$(sameas[em,'co2ubio'] or sameas[em,'co2bio']), 
      uTE.l[CCS_techs,'process_special',ee,'23001',t]
      * uEmmE_BU.l[em,'process_special',ee,'23001',t])
    * 0.9;
...
eP.l[CCS_techs,'process_special','23001',t]$(sqTPotential.l[CCS_techs,'process_special','23001',t]) 
  = eP.l['t1','process_special','23001',t];
