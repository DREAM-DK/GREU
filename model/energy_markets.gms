	...
	$IF %stage% == "variables":
		...
		#MARKET-CLEARING
			...
			$Group+ all_variables
						...
						j_energy_technology_qREa[es,e,i,t]$(d1pEpj_base[es,e,i,t])       "J-term to be activated by energy technology model. When energy technology model is on qREa =/= qEpj, but is guided by energy technology module, endogenizing this variable"
