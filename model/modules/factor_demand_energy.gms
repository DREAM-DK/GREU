...
$SetGroup+ SG_flat_after_last_data_year
  d1E_re_i[energy,i,t] "Dummy. Does industry i use energy inputs for purpose re?"
...
$Group+ all_variables
  ...
  qE2qY_re_i[energy,i,t]$(d1E_re_i[energy,i,t]) "Demand for intermediate energy inputs to output ratio by industry."
  pE_re_i[energy,i,t]$(d1E_re_i[energy,i,t]) "Price index of energy inputs, by industry."
  qE_re_i[energy,i,t]$(d1E_re_i[energy,i,t]) "Real energy inputs by industry."
  vE_re_i[energy,i,t]$(d1E_re_i[energy,i,t]) "Energy inputs by industry and final purpose."
...
$BLOCK factor_demand_energy_equations factor_demand_energy_endogenous $(t1.val <= t.val and t.val <= tEnd.val)
  ...
  .. pE_re_i[energy,i,t] =E=  pD[energy,t];
  .. qE_re_i[energy,i,t] =E= qE2qY_re_i[energy,i,t] * qY_i[i,t];
  .. qD[energy,t] =E= sum(i, qE_re_i[energy,i,t]);
  .. vE_re_i[energy,i,t] =E= pE_re_i[energy,i,t] * qE_re_i[energy,i,t] ;

  .. vE_i[i,t] =E= sum(energy, vE_re_i[energy,i,t]);
...
d1E_re_i[energy,i,t] = abs(qE_re_i.l[energy,i,t]) > 1e-9;
d1E_i[i,t]       = yes$(sum(energy, d1E_re_i[energy,i,t]));
d1Invt_ene_i[i,t]= abs(qInvt_ene_i.l[i,t]) > 1e-9;


pE_re_i.l[energy,i,t]$d1E_re_i[energy,i,t] = fpt[t];
...
$Group calibration_endogenous
  ...
  -qE_re_i[energy,i,t1], qE2qY_re_i[energy,i,t1]
...
$MACRO factor_demand_energy_calibration_starting_values
