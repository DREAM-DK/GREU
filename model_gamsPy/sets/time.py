...
from settings import first_data_year, calibration_year, terminal_year, base_year
...
tBase = Set(name="tBase", domain=t, is_singleton=True, records=[base_year], description="Base year where prices are set to 1")
