...
uTK=gp.Parameter(db_abatement,name='uTK',domain=[l,es,i,t],description='Input of machinery capital in technology l per PJ output output at full potential',records=df_uTK.values.tolist())
