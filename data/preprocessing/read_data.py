...
metadata_dicte=pd.read_excel(r'../data/preprocessing/data/metadata.xlsx',sheet_name='energy_products_pefa_map')
...
non_energy_emissions=pd.read_excel(r'../data/preprocessing/data/non_energy_emissions.xlsx',keep_default_na=True)
...
#regular
io=pd.read_excel(r'../data/preprocessing/data/io_long_format.xlsx')
...
#IO-investment
io_inv=pd.read_excel(r'../data/preprocessing/data/io_invest_long_format.xlsx',keep_default_na=True)
...
'''
employed_fullset=pd.read_excel(r'../data/preprocessing/data/employed.xlsx',keep_default_na=True)
...
fixed_assets=pd.read_excel(r'../data/preprocessing/data/fixed_assets.xlsx',keep_default_na=True)
'''map onto gr-codes'''
...
#ets
ets=pd.read_excel(r'../data/preprocessing/data/ets.xlsx',keep_default_na=True)
...
emissions_bridge_items=pd.read_excel(r'../data/preprocessing/data/emissions_bridge_items.xlsx',keep_default_na=True)
...
#sector data
institutional_financial_accounts=pd.read_excel(r'../data/preprocessing/data/institutional_financial_accounts.xlsx',keep_default_na=True)
...
#government finances
government_finances=pd.read_excel(r'../data/preprocessing/data/government_finances.xlsx',keep_default_na=True)
...
'''
#tax on labour
government_finances_disagg=pd.read_excel(r'../data/preprocessing/data/government_finances.xlsx',keep_default_na=True)
...
metadata_cons_hh=pd.read_excel(r'../data/preprocessing/data/metadata.xlsx',sheet_name='cons_hh',keep_default_na=True)
c_records = list(metadata_cons_hh.itertuples(index=False, name=None))
#populate i and re (with text)
metadata_industries=pd.read_excel(r'../data/preprocessing/data/metadata.xlsx',sheet_name='industries',keep_default_na=True)
...
#populate es (w. text)
metadata_energy_purposes=pd.read_excel(r'../data/preprocessing/data/metadata.xlsx',sheet_name='energy_purposes',keep_default_na=True)
...
metadata_flows=pd.read_excel(r'../data/preprocessing/data/metadata.xlsx',sheet_name='flows',keep_default_na=True)
